...
class _DenunciaScreenState extends State<DenunciaScreen> {
  ...
  bool _validateFields() {
    ...
    return camposPreenchidos && _confirmacao;
  }
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _buildTextField('Data do ocorrido *', 'dd/mm/aaaa', _dataController, icon: Icons.calendar_today),
              const SizedBox(height: 18),
              _buildTextField('Descrição *', 'Descreva a infração...', _descricaoController, maxLines: 4),
              const SizedBox(height: 18),
              _buildTextField('Ponto de referência *', 'Ex: Empresa XYZ', _referenciaController),
              const SizedBox(height: 18),
              _buildTextField('Informações do denunciado *', 'Nome, CPF...', _denunciadoController),
              ...
              Center(
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Concluir denúncia', style: TextStyle(color: Colors.white)),
